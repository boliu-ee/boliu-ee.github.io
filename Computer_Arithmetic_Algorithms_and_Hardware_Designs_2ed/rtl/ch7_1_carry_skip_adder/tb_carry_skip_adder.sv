...
module tb;
    ...
    initial begin
        ...
        check({N{1'b1}}, {N{1'b0}}, 1'b1);   // 全组传播，跳过路径全开
        check(16'hAAAA, 16'h5555, 1'b1);     // 每位都传播
        check(16'h000F, 16'h0001, 1'b0);
        check(16'hF0F0, 16'h0F0F, 1'b1);
        for (i = 0; i < 2000; i = i + 1) begin
            check($random, $random, $random & 1);
        end
        if (errors == 0) begin
            $display("TEST PASSED: carry_skip_adder N=%0d", N);
            $finish;
        end else begin
